...
GNUTERM = "x11"
plot "program_6_3_j1.txt" using 1:2 title "j=1" with linespoints, "program_6_3_j2.txt" using 1:2 title "j=2" with linespoints, "program_6_3_j3.txt" using 1:2 title "j=3" with linespoints
#    EOF
