...
GNUTERM = "x11"
plot "program_6_2_j1.txt" using 1:2 title "j=1" with linespoints, "program_6_2_j2.txt" using 1:2 title "j=2" with linespoints, "program_6_2_j3.txt" using 1:2 title "j=3" with linespoints, "program_6_2_j4.txt" using 1:2 title "j=4" with linespoints
#    EOF
